...
class PPOBuffer:
    """
    A buffer for storing trajectories experienced by the PPO agent interacting
    ...
    def get(self):
        ...
        """
        assert self.ptr == self.max_size  # buffer has to be full before you can use this
        self.ptr, self.path_start_index = 0, 0

        # the next two lines  implement the advantage normalisation trick
